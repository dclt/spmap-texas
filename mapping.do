// mapping do file for texas counties
// Daniel Tihanyi
...
//create fips var by adding State (2 digits) with County (3 digits)
// fips converted to numeric because STATA doesnt allow leading 0
use usdb, replace
